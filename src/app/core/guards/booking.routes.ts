...
export const BOOKING_ROUTES: Routes = [
  {
    path: '',
    // Módulo 2: Búsqueda de hotel (Ciudad, Fecha entrada, Fecha salida)
    loadComponent: () => import('../../features/booking/components/search/search').then(c => c.Search),
    title: 'Buscador de Hoteles'
  },
  {
    path: 'hotel/:id',
    // Módulo 2: Selección de hotel y ver habitaciones disponibles
  ...
  },
  {
    ...
    // Módulo 2: Formulario de reserva y datos del huésped
